...
- **Threshold Value**:  
    ...
    A good starting point for this value is around **10-30** in grayscale when the markers are very dark, but keep in mind that lighting conditions can significantly impact this parameter.

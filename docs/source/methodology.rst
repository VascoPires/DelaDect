...
- ``secondary_similarity_threshold=0.6``
- ``promotion_persistence_frames=3``
- ``onset_policy in {"confirm_then_backfill", "causal"}``
- ``allow_terminal_promotion=True``
...
5. ``multi_interface_levels.png``
   - level map for i0/i1/i2 in distinct colors
6. ``promotion_tail_case.png``
   - final-frame terminal promotion example

Related example
---------------
See :doc:`examples/delamination_multi_interface` for a complete sample-5 walkthrough.

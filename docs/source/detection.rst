...
- :doc:`examples/advanced_options` for split-region crack and delamination input.
- :doc:`examples/delamination_multi_interface` for the sample-4 multi-interface workflow.

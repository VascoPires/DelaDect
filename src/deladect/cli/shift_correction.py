"""Shift correction and strain evaluation tool.

This script runs:

* Shift-distortion correction on a sequence of images.
* Also allows for strain evaluation based on the tracked points however limited.
"""
